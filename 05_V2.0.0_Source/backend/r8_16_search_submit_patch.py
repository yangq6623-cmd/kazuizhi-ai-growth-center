...
from integrations.search_engine_submitter import configure, status, submit_pending
    ...
    def do_post(handler):
        ...
        try:
            ...
            if path.endswith("/config"):
                ...
                handler._json_ok(submit_pending(limit=max(1, min(100, int(payload.get("limit") or 20)))))
