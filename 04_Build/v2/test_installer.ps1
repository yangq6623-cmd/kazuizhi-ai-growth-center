...
$setup = Join-Path $root 'installer_output_v2/Kazuizhi_AI_Enterprise_V2.0.0_Beta_R4_Setup.exe'
...
if ($version.FileVersion -ne '2.0.0.4' -or $version.ProductName -ne 'Kazuizhi AI Enterprise V2.0.0 Beta R4') { throw 'Windows EXE version mismatch' }
