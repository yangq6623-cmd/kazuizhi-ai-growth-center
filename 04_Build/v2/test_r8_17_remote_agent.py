...
def main():
    with tempfile.TemporaryDirectory(prefix="kz-r817-") as temp:
        ...
        try:
            ...
            # R8-17 patch must stay live dynamically for downstream search submission.
            ...
            require(searcher.seo_public_deployer is deployer, "R8-16 search submitter is not using the shared deployer module")
            require(searcher.seo_public_deployer.status is remote_patch.status, "R8-16 search submitter did not resolve R8-17 deploy status dynamically")
