...
$setup = Join-Path $PSScriptRoot '../../installer_output_v2/Kazuizhi_AI_Enterprise_V2.0.0_Beta_Setup.exe'
if (!(Test-Path -LiteralPath $setup)) { throw 'V2 Setup was not produced' }
