...
$setup = Join-Path $PSScriptRoot '../../installer_output_v2/Kazuizhi_AI_Enterprise_V2.1.0_R8_Preview.exe'
if (!(Test-Path -LiteralPath $setup)) { throw 'V2.1.0 R8 Preview Setup was not produced' }
