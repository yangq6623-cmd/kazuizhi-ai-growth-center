...
AppName=Kazuizhi AI Enterprise V2.0.0 Beta R7.1
AppVersion=2.0.0 Beta R7.1
VersionInfoVersion=2.0.0.8
DefaultDirName={localappdata}\Programs\Kazuizhi_AI_Enterprise_V2.0.0_Beta
DefaultGroupName=Kazuizhi AI Enterprise V2.0.0 Beta R7.1
PrivilegesRequired=lowest
ArchitecturesAllowed=x64compatible
ArchitecturesInstallIn64BitMode=x64compatible
OutputDir=..\..\installer_output_v2
OutputBaseFilename=Kazuizhi_AI_Enterprise_V2.0.0_Beta_R7_UX1_Setup
Compression=lzma2
...
[Icons]
Name: "{userdesktop}\卡嘴子 AI 增长运营中心 V2 Beta R7.1"; Filename: "{app}\Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe"
Name: "{group}\卡嘴子 AI 增长运营中心 V2 Beta R7.1"; Filename: "{app}\Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe"

[Run]
Filename: "{app}\Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe"; Description: "启动卡嘴子 AI 增长运营中心 V2 Beta R7.1"; Flags: nowait postinstall skipifsilent
