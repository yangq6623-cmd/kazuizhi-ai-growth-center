...
AppName=Kazuizhi AI Enterprise V2.2.2 R8 Autonomous Mission Core
AppVersion=2.2.2 R8 Autonomous Mission Core
VersionInfoVersion=2.2.2.22
VersionInfoCompany=Kazuizhi
VersionInfoDescription=Kazuizhi AI Enterprise V2.2.2 R8 Autonomous Mission Core Installer
VersionInfoProductName=Kazuizhi AI Enterprise
DefaultDirName={localappdata}\Programs\Kazuizhi_AI_Enterprise_V2.0.0_Beta
DefaultGroupName=Kazuizhi AI Enterprise V2.2.2 R8 Autonomous Mission Core
PrivilegesRequired=lowest
ArchitecturesAllowed=x64compatible
ArchitecturesInstallIn64BitMode=x64compatible
OutputDir=..\..\installer_output_v2
OutputBaseFilename=Kazuizhi_AI_Enterprise_V2.2.2_R8_Autonomous_Mission_Core
Compression=zip
SolidCompression=no
...
[Icons]
Name: "{userdesktop}\卡嘴子 AI 自治运营中心 V2.2.2"; Filename: "{app}\Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe"
Name: "{group}\卡嘴子 AI 自治运营中心 V2.2.2"; Filename: "{app}\Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe"

[Run]
Filename: "{app}\Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe"; Description: "启动卡嘴子 AI 自治运营中心 V2.2.2"; Flags: nowait postinstall skipifsilent
