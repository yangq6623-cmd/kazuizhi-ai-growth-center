...
try {
    & $Python '04_Build/v2/verify_v2.py' --source
    ...
    & $Python '04_Build/v2/verify_v2.py' --exe 'dist_v2/Kazuizhi_AI_Enterprise_V2.0.0_Beta/Kazuizhi_AI_Enterprise_V2.0.0_Beta.exe'
